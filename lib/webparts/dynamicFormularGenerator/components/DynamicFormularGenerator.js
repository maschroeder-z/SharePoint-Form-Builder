...
var DynamicFormularGenerator = /** @class */ (function (_super) {
            ...
            if (!fieldInfo_1.IsUsedInForm) // only once
             {
                ...
                if (typeof this.props.RESTLookupDefinition !== "undefined" && this.props.RESTLookupDefinition !== null) {
                    ...
                    console.log("REST", fieldInfo_1.RESTLookup);
                }
    ...
    DynamicFormularGenerator.prototype.render = function () {
        ...
        if (!this.validateConfiguration()) {
            ...
            var rawFrom = this.props.validFrom.value instanceof Date ? this.props.validFrom.value : new Date(this.props.validFrom.value);
            var rawTo = this.props.validTo.value instanceof Date ? this.props.validTo.value : new Date(this.props.validTo.value);
            if (this.props.validFrom !== null && rawFrom >= currentDate) {
                ...
                return (React.createElement("div", null,
                    ...
                    React.createElement("img", { src: require('../../../assets/form-closed@800x600.png'), alt: "Formular geschlossen" })));
            }
