...
var FormControlFluentUI = /** @class */ (function (_super) {
    ...
    FormControlFluentUI.prototype.renderFormControl = function () {
        ...
        var onOptionSelect = function (e, data) {
            var _a;
            _this.setState({
                currentFormValue: (_a = data.optionText) !== null && _a !== void 0 ? _a : ''
            });
        };
        console.log(this.props.RESTLookup);
        if (typeof this.props.RESTLookup !== "undefined" && this.props.RESTLookup !== null) {
            return (React.createElement("div", null,
                React.createElement(Combobox, { inlinePopup: true, value: this.state.currentFormValue, id: this.props.InternalName, onOptionSelect: onOptionSelect, onChange: function (ev) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    this.setState({
                                        currentFormValue: (_a = ev.target.value) !== null && _a !== void 0 ? _a : ''
                                    });
                                ...
                                case 2:
                                    ...
                                    mapped = body[this.props.RESTLookup.CollectionPropertyName].map(function (n) {
                                        return { Title: n.LastName + ", " + n.FirstName, Value: n[_this.props.RESTLookup.IDPropertyName] };
                                    });
                                    this.setState({
                                ...
                                case 3:
                                    this.setState({
                                        currentFormValue: (_b = ev.target.value) !== null && _b !== void 0 ? _b : ''
                                    });
                                    _c.label = 4;
                                case 4: return [2 /*return*/];
                            }
                        });
                    }); } }, this.state.lookupChoices && this.state.lookupChoices.map(function (element) { return (React.createElement(Option, { key: element.Value }, element.Title)); }))));
        }
        return (React.createElement("div", null,
