    ...
    FormControlFluentUI.prototype.renderFormControl = function () {
        ...
        if (this.props.FieldTypeKind === FieldTypes.NUMBER || this.props.FieldTypeKind === FieldTypes.CURRENCY) {
            ...
            if (this.props.MaximumValue !== Number.MAX_VALUE)
                placeHolder = "".concat(placeHolder.length > 0 ? placeHolder + " bis max. " : "Max. Wert: ", " ").concat(this.props.MaximumValue); // TODO i18n
            return (React.createElement("div", null,
        ...
        if (typeof this.props.RESTLookup !== "undefined" && this.props.RESTLookup !== null) {
            return (React.createElement("div", null,
                React.createElement(Combobox, { value: (this.state.currentFormValue !== null ? this.state.currentFormValue.Display : ""), id: this.props.InternalName, onOptionSelect: onOptionSelect, onChange: function (ev) { return __awaiter(_this, void 0, void 0, function () {
